...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 mx-auto">
            <br> <br>
            <form id="demo-form2" action="<?php echo e(route('postSubmit')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <textarea type="text" name="description" id="description" required="required" class="form-control"></textarea>
                    </div>
                </div>
                <div class="item form-group">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="date" name="postDate" id="date" class="form-control" required>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Blog\resources\views/admin/managePost.blade.php ENDPATH**/ ?>