            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-table"></i> View-Post </a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Manage-Post</a>
                  </li>
                </ul>
              </div>
            </div>
...
<?php /**PATH D:\Laravel\Blog\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>