...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 mx-auto">
            <br> <br>
            <form id="demo-form2" action="{{ route('updatePostComplete', [$result->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <textarea type="text" name="description" id="description" class="form-control" required>{{$result->description}}</textarea>
                    </div>
                </div>
                <div class="item form-group">
                    <label for="image" class="col-form-label col-md-3 col-sm-3 label-align">Image*</label>
                    <div class="col-md-6 col-sm-6 ">
                        <input type="file" name="image" id="image" class="form-control" value="{{$result->image}}" required>
                    </div>
                </div>
                <div class="item form-group">
                    <label for="date" class="col-form-label col-md-3 col-sm-3 label-align">Date*</label>
                    <div class="col-md-6 col-sm-6 ">
                        <input type="date" name="postDate" id="date" class="form-control" value="{{$result->postDate}}" required>
                    </div>
                </div>
